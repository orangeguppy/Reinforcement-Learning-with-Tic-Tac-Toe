...
#         '''Step 2'''
#         # The key would be an encoded combination of the state-action pair
#         self.Q_table = {}
...
#             all_pairs_per_state = self.generate_possible_actions_per_state(state)
...
#     def generate_all_state_action_pairs(self, state, actions):
#         state_action_pairs = []
...
# print(generate_possible_states()[0])
# print(len(generate_possible_states()))